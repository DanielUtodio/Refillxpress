...
import BgrmLogo from "../assets/imgs/BgrmLogo.png" 
      ...
      <footer className="footer">
        <section className="top">
            <div className="column-one">
                <h2 className='logo-style'>refill<span className='logo-heading'>Xpress</span></h2>
                <p>
            ...
            <div className="column-one">
                ...
                <p>
                    Get the latest updates, news, and
        ...
        <section className="bottom">
            <div className="left">
                <h2>Copywright 2025 @ refillxpress, <span>Design</span></h2>
            </div>
            <div className="right">
                <BsWhatsapp className='wa-icon' />
                <FaFacebook className='fb-icon'/>
                <img src={BgrmLogo} className='ig-icon' />
                <BsTwitterX />
